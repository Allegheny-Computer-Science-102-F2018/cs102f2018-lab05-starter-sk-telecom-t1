...
# This work is mine unless stated otherwise
from tkinter import*
import math
import parser
...
btnExp = Button(calc, text="Exp", width=6, height=2, font=('arial',20,'bold') , bd=4,
            bg ="gold", command = added_value.expm1).grid(row=3, column=5, pady=1)
btnMod = Button(calc, text="Mod", width=6, height=2, font=('arial',20,'bold') , bd=4,
            bg ="gold").grid(row=3, column=6, pady=1)
...
btndeg = Button(calc, text="deg", width=6, height=2, font=('arial',20,'bold') , bd=4,
            bg ="gold", command = added_value.degrees).grid(row=4, column=5, pady=1)
btnacosh = Button(calc, text="acosh", width=6, height=2, font=('arial',20,'bold') , bd=4,
            bg ="gold", command = added_value.acosh).grid(row=4, column=6, pady=1)
...
btngamma = Button(calc, text="1gamma", width=6, height=2, font=('arial',20,'bold') , bd=4,
            bg ="gold",command = added_value.lgamma).grid(row=5, column=7, pady=1)
